...
# I'm taking the vcf file from SNP nexus, that was obtained by inputting the rs IDs obtained from the T1D GWAS data. 
...
# the file with the genetic coordinates of chr6: gen_coords_chr6_only.vcf
...
# and then a database was created from the dictionaries 
